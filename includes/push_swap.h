...
/*   Updated: 2021/05/31 17:40:15 by taemkim          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			algo(t_stack **a, t_stack **b, int len, t_data *all);
void			switch_case(t_stack **a, t_stack **b, int w, t_data *all);
void			algo_1(t_stack **a, t_stack **b, int len, t_data *all);
void			algo_min(t_stack **a, t_stack **b, int len, int k);
void			checker_pars(t_stack **a, t_stack **b, char *line);
void			sort_a_3(t_stack **a, t_stack **b, int len, t_data *all);
void			sort_min(t_stack **a, t_stack **b, int len, t_data *all);
...
void			ft_swap(t_data *all, int ac, char **av);
void			swap_c(t_data *all, int ac, char **av);
void			swap_sh(t_data *all, int ac, char **av);
...
void			option_v(t_data *all, int ac, char **av);
void			free_arg(char **arg);
void			free_stack(t_stack **stack);
void			free_single_stack(t_stack **stack);
void			ft_free_split(char **split);
void			norm_part1(t_stack **a, t_stack **b, t_data *all, int m);
void			norm_part3(t_stack **a, t_stack **b, t_data *all, int max);
void			norm_part3_c(t_stack **a, t_stack **b, int max, int k);
void			norm_part1_c(t_stack **a, t_stack **b, int m, int k);
void			ft_bzero(void *s, size_t n);
char			**normal(t_data *all, int ac, char **av);
char			**ft_split(char const *s, char c);
char			*ft_strdup(const char *src);
char			*ft_strjoin(char const *s1, char const *s2);
char			**fill_ps(t_data *all, int ac, char **av);
...
t_stack			*put_in_list(t_data *all, char **av, t_stack *new);
t_stack			*creat_stack(char *av, t_stack *a);
t_stack			*dup_list(t_stack *head);
t_data			*fill_in(t_data *all);
t_data			*initial(t_data *all);
